...
public class CustomDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public CustomDialog create() {
            ...
            if (buttonNumber == 1) {
                layout.findViewById(R.id.opera_lp_2).setVisibility(View.GONE);
                layout.findViewById(R.id.opera_lp_1).setVisibility(View.VISIBLE);
                ...
                layout.findViewById(R.id.opera_lp_1).setVisibility(View.VISIBLE);
                layout.findViewById(R.id.second_line).setVisibility(View.GONE);
                layout.findViewById(R.id.single_line).setVisibility(View.VISIBLE);
            } else {
                // if no confirm button or cancle button or neutral just set the
                // visibility to GONE
                layout.findViewById(R.id.opera_lp_2).setVisibility(View.VISIBLE);
                layout.findViewById(R.id.opera_lp_1).setVisibility(View.GONE);
                layout.findViewById(R.id.second_line).setVisibility(View.VISIBLE);
                layout.findViewById(R.id.single_line).setVisibility(View.VISIBLE);
            }
            // set the confirm button
            if (confirm_btnText != null) {
                Button confirm;
                if (buttonNumber > 2) confirm = (Button) layout.findViewById(R.id.confirm_btn_2);
                else confirm = (Button) layout.findViewById(R.id.confirm_btn);
            ...
            if (cancel_btnText != null) {
                Button cancel;
                if (buttonNumber > 2) cancel = (Button) layout.findViewById(R.id.cancel_btn_2);
                else cancel = (Button) layout.findViewById(R.id.cancel_btn);
            ...
            if (neutral_btnText != null) {
                Button neutral;
                if (buttonNumber > 2) neutral = (Button) layout.findViewById(R.id.neutral_btn_2);
                else neutral = (Button) layout.findViewById(R.id.neutral_btn);
            ...
            if (message != null) {
                ...
                ((RelativeLayout) layout.findViewById(R.id.content)).addView(contentView, new LayoutParams(
